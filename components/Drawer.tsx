  ...
  return (
    <div className='drawer drawer-end'>
      ...
      <div className='drawer-content'>
        <label
          htmlFor='drawer'
          className='drawer-button btn btn-square btn-ghost normal-case text-md font-medium lg:hidden'
        >
      ...
      <div className='drawer-side z-10'>
        ...
        ></label>
        <div className='menu flex flex-col w-80 sm:w-[360px] h-screen justify-between min-h-full bg-base-100 text-base-content'>
